...
resource pipDomainjoin 'Microsoft.Compute/virtualMachines/extensions@2020-06-01' = [for (vmConfig, i) in pipVmConfigurations: {
  name: '${vmConfig.resourceName}/domainjoin'
  location: location
  tags: tags
  properties: {
...
resource noPipdomainjoin 'Microsoft.Compute/virtualMachines/extensions@2020-06-01' = [for (vmConfig, i) in vmConfigurations:{
  name: '${vmConfig.resourceName}/domainjoin'
  location: location
  tags: tags
  properties: {
