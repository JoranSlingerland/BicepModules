...
resource sqlDatabase 'Microsoft.Sql/servers/databases@2021-02-01-preview' = [for database in sqlDatabases: {
  ...
  properties: {
    ...
    maintenanceConfigurationId: '/subscriptions/6a745fe0-f83a-47d6-b07f-5999ec6e5def/providers/Microsoft.Maintenance/publicMaintenanceConfigurations/SQL_Default'
    isLedgerOn: false
  }
}]
